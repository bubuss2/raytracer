...
class Vector3
{
  ...
  public:
    ...
    Vector3 operator+(const Vector3 &v)
    {
        return Vector3(this->values[0] + v.values[0], this->values[1] + v.values[1], this->values[2] + v.values[2]);
    }
    ...
    {
        return Vector3(this->values[0] * t, this->values[1] * t, this->values[2] * t);
    }
